...
public class Consumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DefaultMQPushConsumer consumerSync = new DefaultMQPushConsumer("DelayGroup");
        //2.	指定NameServer地址
        consumerSync.setNamesrvAddr("192.168.0.141:9876");
        //3.	订阅主题Topic和Tag
        consumerSync.subscribe("DelayTopic","TagDelay");
        ...
        consumerSync.registerMessageListener((List<MessageExt> list, ConsumeConcurrentlyContext consumeConcurrentlyContext) -> {
            list.forEach(x -> System.out.println("msg = " + new String(x.getBody()) + "延时时间 = " + (System.currentTimeMillis() - x.getStoreTimestamp())));
